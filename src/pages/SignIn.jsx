      ...
      <Container>
        <SignUpContainer signIn={signIn} >
          <Form>
            ...
            <Input type="text" placeholder="Name" onChange={(e)=>{setName(e.target.value)}} autocomplete="on" ></Input>
            <Input type="email" placeholder="Email" onChange={(e)=>{setEmail(e.target.value)}} autocomplete="on" ></Input>
            <Input type="password" placeholder="Password" onChange={(e)=>{setPassword(e.target.value)}}  autocomplete="new-password" ></Input>
            <Input type="password" placeholder="Re-type Password" onChange={(e)=>{setRepeatedPassword(e.target.value)}}  autocomplete="new-password" ></Input>
...
/>
        ...
        <SignInContainer signIn={signIn} >
          <Form>
            <Title>Sign In</Title>
            <Input type="Username" placeholder="Username" onChange={(e)=>{setName(e.target.value)}} ></Input>
            <Input type="password" placeholder="Password" onChange={(e)=>{setPassword(e.target.value)}}  autocomplete="current-password" ></Input>
